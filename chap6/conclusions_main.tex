...
First, the development of the behavioral-computational environment validated the \textit{Convenience Hypothesis}. The variance-based Global Sensitivity Analysis (GSA) utilizing the Sobol method revealed that the \textit{Cost of Effort} parameter ($c_{\text{effort}}$) accounted for approximately 83\% of the variance in systemic compliance rates. This computationally proved that structural friction—not a lack of awareness—is the primary inhibitor of waste segregation in the Philippine context \citep{Yazawa2025}. Conversely, the \textit{Attitude} parameter exhibited near-zero direct sensitivity, quantifying the \textit{Value-Action Gap} and confirming that passive Information, Education, and Communication (IEC) campaigns exhibit severe diminishing returns when the physical barriers to compliance remain unaddressed \citep{Zhao2022}.
