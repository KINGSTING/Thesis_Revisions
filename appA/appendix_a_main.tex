...
\subsection{Barangay Binuni Appropriation Ordinance No. 02-2025}
\label{appendix:appro_ord_binuni}
\includepdf[pages=-, scale=0.9, pagecommand={}]{appA/Appro_Ord_Binuni.pdf}

\subsection{Barangay Ezperanza Appropriation Ordinance No. 01-2025}
\label{appendix:appro_ord_ezperanza}
\includepdf[pages=-, scale=0.9, pagecommand={}]{appA/Appro_Ord_Ezperanza.pdf}

\subsection{Barangay Demologan Appropriation Ordinance No. 01-2025}
\label{appendix:appro_ord_demologan}
\includepdf[pages=-, scale=0.9, pagecommand={}]{appA/Appro_Ord_Demologan.pdf}
