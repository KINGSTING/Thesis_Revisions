...
Experimental studies by \citet{Centola2018} and \citet{Andre2021} demonstrated that overturning established norms does not require majority consensus. Instead, once a committed minority reaches a ``tipping point''---approximated at \textit{25\% of the population}---they trigger a rapid cascade of adoption across the remaining majority. \citet{Nyborg2024} describe this as a ``virtuous cycle'' of self-reinforcing behavior.
