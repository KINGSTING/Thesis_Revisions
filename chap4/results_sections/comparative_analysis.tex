...
\begin{table}[ht]
    ...
    \begin{minipage}{0.9\textwidth}
        \footnotesize
        \textit{Note: Global Compliance is calculated as the true population-weighted mean of the segregation rates across the seven constituent barangays, accurately reflecting the impact of high-density areas. While static policies stagnate deeply within the Collapse Zone ($<40\%$), the Adaptive Strategy forces a massive early-stage behavioral shift and successfully maintains asymptotic stability ($>90\%$) through Year 3. The Pure Enforcement scenario was terminated at Quarter 2 due to the Mayor Agent breaching the critical Political Capital threshold (0.10).}
    \end{minipage}
\end{table}
