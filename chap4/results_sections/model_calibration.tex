...
\begin{table}[htbp]
    ...
    \raggedright
    \footnotesize
    \textit{Note: ``Acquired Data'' refers to unverified compliance rates reported during Key Informant Interviews (Appendix B). ``Calibrated $S_0$'' refers to the initialized compliance state in the Agent-Based Model, tuned to match the aggregate municipal segregation rate of $\approx$12.5\% verified by MENRO.}
\end{table}
