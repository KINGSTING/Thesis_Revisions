...
%   Barangay Demologan
%---------------------------------------------------------
\section{Barangay Demologan}
\label{appendix:demologan_interview}

\noindent
\textbf{Resource Person:} Ms. Melissa Aguinid \\
...
\textbf{A:} Our environmental budget for this year is 21,000 Pesos.

\vspace{0.3cm}

\noindent \textbf{Q: How much manpower do you have for this program?} \\
\textbf{A:} We have 23 personnel, including the Committee on SWM, BHI, and BHWs.

\vspace{0.3cm}

\noindent \textbf{Q: Regarding enforcement costs: Do you impose fines or penalties?} \\
\textbf{A:} We conduct household inspections by Purok (``By Purok Ganid'').

\vspace{0.3cm}

\noindent \textbf{Q: Regarding incentives: Do you have a rewards program?} \\
\textbf{A:} No, we do not have incentives at the moment.
...
\textbf{A:} The effort is low because we have an MRF and a collector available.

\vspace{0.3cm}

\noindent \textbf{Q: How strong are the Social Norms here? Do neighbors influence each other?} \\
\textbf{A:} Awareness is high due to strong IEC campaigns.

\vspace{0.3cm}

\noindent \textbf{Q: Have you noticed any ``Decay'' in attitude? Do they go back to old habits?} \\
\textbf{A:} Decay is low. For many, segregation has become a hobby.
...
\textbf{A:} There is low political sensitivity.

\vspace{0.3cm}

\noindent \textbf{Q: If you had extra budget, where would you put it?} \\
\textbf{A:} We would construct a huge MRF.
