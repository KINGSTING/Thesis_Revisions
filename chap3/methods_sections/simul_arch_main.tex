...
\end{itemize}
The total simulation horizon is fixed at $T = 1,080$ ticks (3,600 during training), representing the standard three-year political term of Philippine local officials.
